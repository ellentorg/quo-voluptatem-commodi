# @ellentorg/quo-voluptatem-commodi

**Splits a hostname into subdomains, domain and (effective) top-level domains.**

[![Version on NPM](https://img.shields.io/npm/v/@ellentorg/quo-voluptatem-commodi?style=for-the-badge)](https://www.npmjs.com/package/@ellentorg/quo-voluptatem-commodi)
...
[![Monthly downloads on NPM](https://img.shields.io/npm/dm/@ellentorg/quo-voluptatem-commodi?style=for-the-badge)](https://www.npmjs.com/package/@ellentorg/quo-voluptatem-commodi)<br>
[![NPM Bundle size minified](https://img.shields.io/bundlephobia/min/@ellentorg/quo-voluptatem-commodi?style=for-the-badge)](https://bundlephobia.com/result?p=@ellentorg/quo-voluptatem-commodi)
[![NPM Bundle size minified and gzipped](https://img.shields.io/bundlephobia/minzip/@ellentorg/quo-voluptatem-commodi?style=for-the-badge)](https://bundlephobia.com/result?p=@ellentorg/quo-voluptatem-commodi)<br>
[![License](https://img.shields.io/npm/l/@ellentorg/quo-voluptatem-commodi?style=for-the-badge)](./LICENSE)

Since domain name registrars organize their namespaces in different ways, it's not straight-forward to split a hostname into subdomains, the domain and top-level domains. In order to do that **@ellentorg/quo-voluptatem-commodi** uses a [large list of known top-level domains](https://publicsuffix.org/list/public_suffix_list.dat) from [publicsuffix.org](https://publicsuffix.org/):

```javascript
import { parseDomain, ParseResultType } from "@ellentorg/quo-voluptatem-commodi";
...
```sh
npm install @ellentorg/quo-voluptatem-commodi
```

## Updates

💡 **Please note:** [publicsuffix.org](https://publicsuffix.org/) is updated several times per month. This package comes with a prebuilt list that has been downloaded at the time of `npm publish`. In order to get an up-to-date list, you should run `npx @ellentorg/quo-voluptatem-commodi-update` everytime you start or build your application. This will download the latest list from `https://publicsuffix.org/list/public_suffix_list.dat`.
...
```javascript
import { parseDomain, fromUrl } from "@ellentorg/quo-voluptatem-commodi";
...
```javascript
import { parseDomain, ParseResultType, Validation } from "@ellentorg/quo-voluptatem-commodi";
...
See also [#134](https://github.com/ellentorg/quo-voluptatem-commodi/issues/134) for the discussion.
...
```javascript
const { subDomains, domain, topLevelDomains } = parseDomain(
  "@ellentorg/quo-voluptatem-commodi.github.io"
);

console.log(subDomains); // []
console.log(domain); // "@ellentorg/quo-voluptatem-commodi"
...
```javascript
const parseResult = parseDomain("@ellentorg/quo-voluptatem-commodi.github.io");
const { subDomains, domain, topLevelDomains } = parseResult.icann;

console.log(subDomains); // ["@ellentorg/quo-voluptatem-commodi"]
...
```javascript
import { parseDomain } from "@ellentorg/quo-voluptatem-commodi";
...
```javascript
import { parseDomain, Validation } from "@ellentorg/quo-voluptatem-commodi";
...
⚠️ Reserved IPs, such as `127.0.0.1`, will not be reported as reserved, but as <a href="#-export-parseresultip">`ParseResultIp`</a>. See [#117](https://github.com/ellentorg/quo-voluptatem-commodi/issues/117).
...
{
  type: "LISTED",
  hostname: "@ellentorg/quo-voluptatem-commodi.github.io",
  labels: ["@ellentorg/quo-voluptatem-commodi", "github", "io"]
  subDomains: [],
  domain: "@ellentorg/quo-voluptatem-commodi",
  topLevelDomains: ["github", "io"],
  icann: {
    subDomains: ["@ellentorg/quo-voluptatem-commodi"],
    domain: "github",
    topLevelDomains: ["io"]
  }
}
